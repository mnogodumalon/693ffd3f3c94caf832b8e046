...
export function SchulungstermineDialog({ open, onClose, onSubmit, defaultValues, schulungskatalogList, trainerList, raeumeList, enablePhotoScan = true, enablePhotoLocation = true }: SchulungstermineDialogProps) {
