...
export function ZertifikateDialog({ open, onClose, onSubmit, defaultValues, teilnehmerverwaltungList, mitarbeiterList, schulungskatalogList, enablePhotoScan = true, enablePhotoLocation = true }: ZertifikateDialogProps) {
