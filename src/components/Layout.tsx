...
import { IconArrowBackUp, IconBook, IconDoorEnter, IconFileText, IconLayoutDashboard, IconMenu2, IconSchool, IconSettings, IconUsers } from '@tabler/icons-react';
...
const APP_TITLE = 'Schulungsverwaltung';
...
const navigation = [
  ...
  { name: 'Schulungstermine', href: '/schulungstermine', icon: IconBook },
  { name: 'Schulungsanmeldung', href: '/schulungsanmeldung', icon: IconBook },
  { name: 'Trainer', href: '/trainer', icon: IconSchool },
  { name: 'Teilnehmerverwaltung', href: '/teilnehmerverwaltung', icon: IconUsers },
  { name: 'Zertifikate', href: '/zertifikate', icon: IconFileText },
  { name: 'Bewertungen', href: '/bewertungen', icon: IconFileText },
  { name: 'Räume', href: '/raeume', icon: IconDoorEnter },
  { name: 'Mitarbeiter', href: '/mitarbeiter', icon: IconUsers },
  { name: 'Schulungskatalog', href: '/schulungskatalog', icon: IconBook },
];

const externalNavigation = [
  { name: 'Schulungstermine', href: '/gateway/apps/693ffd1c598f914b8770d838?template=list_page', icon: IconBook },
  { name: 'Schulungsanmeldung', href: '/gateway/apps/693ffd1ed4fbbcda56f1b83e?template=list_page', icon: IconBook },
  { name: 'Trainer', href: '/gateway/apps/693ffd1961c93d563b523829?template=list_page', icon: IconSchool },
  { name: 'Teilnehmerverwaltung', href: '/gateway/apps/693ffd1c2abdda157f9b3873?template=list_page', icon: IconUsers },
  { name: 'Zertifikate', href: '/gateway/apps/69400b1ad27549fae3a988e8?template=list_page', icon: IconFileText },
  { name: 'Bewertungen', href: '/gateway/apps/693ffd1d0fd5fac77b223db6?template=list_page', icon: IconFileText },
  { name: 'Räume', href: '/gateway/apps/693ffd1ab347945f97bce858?template=list_page', icon: IconDoorEnter },
  { name: 'Mitarbeiter', href: '/gateway/apps/693ffd127128a18c7909c8d2?template=list_page', icon: IconUsers },
  { name: 'Schulungskatalog', href: '/gateway/apps/693ffd1b64c092bd3fb64dec?template=list_page', icon: IconBook },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/693ffd1c598f914b8770d838?template=list_page"
