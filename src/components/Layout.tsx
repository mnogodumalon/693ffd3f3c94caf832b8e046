...
import { BookOpen, DoorOpen, FileText, GraduationCap, LayoutDashboard, Menu, Settings, Undo2, Users } from 'lucide-react';
...
const navigation = [
  ...
  { name: 'Schulungstermine', href: '/schulungstermine', icon: BookOpen },
  { name: 'Zertifikate', href: '/zertifikate', icon: FileText },
  { name: 'Schulungsanmeldung', href: '/schulungsanmeldung', icon: BookOpen },
  { name: 'Räume', href: '/raeume', icon: DoorOpen },
  { name: 'Trainer', href: '/trainer', icon: GraduationCap },
  { name: 'Bewertungen', href: '/bewertungen', icon: FileText },
  { name: 'Teilnehmerverwaltung', href: '/teilnehmerverwaltung', icon: Users },
  { name: 'Schulungskatalog', href: '/schulungskatalog', icon: BookOpen },
  { name: 'Mitarbeiter', href: '/mitarbeiter', icon: Users },
];

const externalNavigation = [
  { name: 'Schulungstermine', href: '/gateway/apps/693ffd1c598f914b8770d838?template=list_page', icon: BookOpen },
  { name: 'Zertifikate', href: '/gateway/apps/69400b1ad27549fae3a988e8?template=list_page', icon: FileText },
  { name: 'Schulungsanmeldung', href: '/gateway/apps/693ffd1ed4fbbcda56f1b83e?template=list_page', icon: BookOpen },
  { name: 'Räume', href: '/gateway/apps/693ffd1ab347945f97bce858?template=list_page', icon: DoorOpen },
  { name: 'Trainer', href: '/gateway/apps/693ffd1961c93d563b523829?template=list_page', icon: GraduationCap },
  { name: 'Bewertungen', href: '/gateway/apps/693ffd1d0fd5fac77b223db6?template=list_page', icon: FileText },
  { name: 'Teilnehmerverwaltung', href: '/gateway/apps/693ffd1c2abdda157f9b3873?template=list_page', icon: Users },
  { name: 'Schulungskatalog', href: '/gateway/apps/693ffd1b64c092bd3fb64dec?template=list_page', icon: BookOpen },
  { name: 'Mitarbeiter', href: '/gateway/apps/693ffd127128a18c7909c8d2?template=list_page', icon: Users },
];
